 ...
 *    ULONG		>= 32 bits, >= pointer size (unsigned)	*
 ****************************************************************/
 ...
 * Numbers are stored in base INT_BASE, which must be a power   *
 * of 2.							*
 *								*
...
/*--------------------------------------------------------------*
 * HALF_DIGIT_PLUS_BIT is 2*sqrt(INT_BASE).			*
 *--------------------------------------------------------------*/
 ...
 * do memory operations on large arrays.  For other implementations,    *
