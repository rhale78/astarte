 ...
 *
 *            Alignment:    align on appropriate boundaries
 *
...
/****************************************************************
 * LONG_IS_64_BITS is defined to indicate that a long int is    *
 * 64 bits.							*
 ****************************************************************/
...
#define LONG_BITS	64		/* Bits in a LONG 		*/
#define LOG_LONG_BITS	6		/* Log base 2(LONG_BITS)	*/
#define LONG_BYTES	8		/* Bytes in a LONG 		*/
#ifndef LONG_MAX
# define LONG_MAX       9223372036854775807L	/* Max value of a LONG	*/
#endif
#ifndef ULONG_MAX
# define ULONG_MAX	18446744073709551615L	/* Max value of a ULONG	*/
#endif
...
#define LOG_LONG_BITS_MASK 	0x3f
#define LONG_SIGN_MASKOUT	0x7fffffffffffffffL
...
/*----------------------------------------------------------------------*
 * DOUBLE_ALIGN is a mask such that x & LONG_ALIGN is 0 if x is		*
 * an address where a LONG can be stored.				*
 *									*
...
#define DOUBLE_ALIGN		7
#define TRUE_DBL_ALIGN		7
#define DBL_BLOCK_ALIGN		0x1FFL
 ...
 *								*
 * Due to storage allocation needs, it is currently required	*
 * that type intcell be the same as USHORT (i.e., 16 bits.)	*
 *								*
...
/*----------------------------------------------------------------------*
 * CHUNK_MIN_SIZE is the smallest multiple of LONG_BYTES that is not	*
...
#define PTR_BYTES	8	/* Bytes in a pointer 		*/
#define PTR_SHORTS	4	/* SHORTS in a pointer 		*/
...
# define longmemset memset
# define longstrcpy strcpy
